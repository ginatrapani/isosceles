...
class TestOfFixtureBuilder extends IsoscelesBasicUnitTestCase {
    ...
    public function testTruncateTable() {
        ...
        try {
            ...
            $this->assertPattern('/Unable to truncate table "iso_notable"/', $e->getMessage());
        }
    ...
    public function testDescribeTable() {
        try {
            ...
            $this->assertPattern('/Unable to describe table "iso_notable"/', $e->getMessage());
        }
