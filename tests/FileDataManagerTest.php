...
class FileDataManagerTest extends IsoscelesBasicUnitTestCase {
    ...
    public function testGetDataPathNoConfigFile() {
        ...
        $this->assertEquals($path, ISOSCELES_PATH.'data/');

        //test path with file
        $path = FileDataManager::getDataPath('myfile.txt');
        $this->assertEquals($path, ISOSCELES_PATH.'data/myfile.txt');
    ...
    public function testGetDataPathConfigExistsWithDataDirValue() {
        ...
        //test just path
        $path = FileDataManager::getDataPath();
        $this->assertEquals($path, $ISOSCELES_CFG['datadir_path']);

        //test path with file
        $path = FileDataManager::getDataPath('myfile.txt');
        $this->assertEquals($path, $ISOSCELES_CFG['datadir_path'].'myfile.txt');
    }
    ...
    public function testGetBackupPath() {
        ...
        $this->assertEquals($path, $ISOSCELES_CFG['datadir_path'].'backup/');

        //test just path
        $path = FileDataManager::getBackupPath('README.txt');
        $this->assertEquals($path, $ISOSCELES_CFG['datadir_path'].'backup/README.txt');
    }
}