 ...
 *
 * Example controller to demonstrate an implementation of the Controller abstract class which returns JSON.
 *
 * @license http://www.gnu.org/licenses/gpl.html
 */

class IsoscelesExampleJSONController extends Controller {
    ...
    public function control() {
        ...
        $profiler->add(0, "Rendered view from ". $cache_source . ", cache key: <i>".
